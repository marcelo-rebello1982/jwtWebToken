...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private JwtRequestFilter buildJwtRequestFilter() throws Exception{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.addFilterBefore(this.buildJwtRequestFilter(), UsernamePasswordAuthenticationFilter.class);
   			...
   			requests
        		...
        		.authorizeRequests(requests ->
        			requests
						...
						"/" + pathFilter + "/jwtauthentication/auth/user/**")
						.permitAll())
        		.authorizeRequests(requests ->
        			requests
